...
export async function loadProductionConfiguration(root = resolve(dirname(fileURLToPath(import.meta.url)), "../..")) {
  ...
  for (const utility of [
    ...
    "scripts/production/apply-steam-depot-finalizer-host-transaction.mjs",
    "scripts/production/compile-steam-depot-finalizer-host-transaction.mjs",
    "scripts/production/plan-steam-depot-finalizer-host-install.mjs",
    "scripts/production/stage-steam-depot-finalizer-host-install.mjs",
    ...
    "scripts/production/finalize-agent-microvm-guest-rootfs.mjs",
    ...
    "scripts/production/inspect-agent-microvm-guest-trust-policy.mjs",
