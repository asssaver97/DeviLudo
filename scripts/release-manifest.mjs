...
await writeFile(output, JSON.stringify({
  ...
  plugins: {
    GODOT: {
      ...
      testManifestContract: "deviludo.test-manifest",
      guestReportContract: "deviludo.godot-guest-report",
      evidenceContract: "deviludo.e2e-evidence",
      guestActions: ["test"],
      runtimeInputSmoke: "GODOT_SYSTEM_KEYBOARD_POINTER_GAMEPAD",
      gamepadBackends: { macos: "CORE_HID", linux: "UINPUT", windows: "KMDF_VHF" },
      macosGoldenImage: "TAHOE_26",
