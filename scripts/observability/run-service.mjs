...
export const SERVICE_ENTRYPOINTS = Object.freeze({
  ...
  "runner-capacity-controller": Object.freeze({ entry: "services/runner-control/src/run-capacity-controller.ts" }),
  "p0-runtime-readiness": Object.freeze({ entry: "services/runner-control/src/run-p0-readiness-service.ts" }),
  ...
  "steam-depot-finalizer": Object.freeze({ entry: "services/steam-depot-finalizer/src/run-service.ts" }),
  "steam-depot-finalizer-host-activation": Object.freeze({ entry: "services/steam-depot-finalizer/src/run-host-activation-authority.ts" }),
