  ...
  return {
    ...
    payload: {
      ...
      receipt: {
        ...
        codeReviewReceipt: {
          schemaVersion: "deviludo.agent-code-review-receipt.v1", receiptId: "review-attempt-001",
          runId, attemptId: "attempt-001", profileRevisionId: "profile-r1", installationId: "installation-r1",
          ...
          verdict: "PASSED", reviewDigest: "e".repeat(64), findingCount: 0, warningCount: 0,
