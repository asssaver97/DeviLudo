...
function capability(resourceKind: "STEAM_ENROLLMENT" | "STEAM_RELEASE_APPROVAL", resourceId: string,
  action: "SUBMIT_CREDENTIALS" | "SUBMIT_GUARD_CODE" | "COMPLETE_RELEASE_MFA") {
