...
export function HomeIcon(props: IconProps) {
  return (
    <IconBase {...props}>
      <path d="m4 10 8-7 8 7v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-9Z" {...stroke} />
...
export function SendIcon(props: IconProps) {
  return (
    <IconBase {...props}>
      <path d="m21 3-7.4 18-3.5-7.1L3 10.4 21 3Z" {...stroke} />
      <path d="m10.1 13.9 4.5-4.5" {...stroke} />
    </IconBase>
  );
}
