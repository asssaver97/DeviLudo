  ...
  return (
    <AppShell>
      <section className="page-heading resource-heading">
        ...
        <div className="resource-heading-actions"><ProjectScopeSelector projects={projects} selectedProjectId={selectedProjectId} onChange={selectProject} /><span className="resource-stat"><b>{project ? (evidence?.valid ? 1 : 0) + (mainEvidence?.valid ? 1 : 0) + (steamEvidence?.valid ? 1 : 0) || validProductionEvidence : 0}</b><small>有效证据包</small></span></div>
      </section>
